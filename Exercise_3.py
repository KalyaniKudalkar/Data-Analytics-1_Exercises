...
# 1. T-Test: Compare mean petal lengths of Setosa and Versicolor
...
# No critical value check here for simplicity.

# 3. ANOVA: Compare petal widths across all three species
...
# 4. Correlation: Relationship between sepal length and petal length
